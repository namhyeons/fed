...
def multi_resnet18_kd(n_blocks=4, num_classes=1000, norm='gn'):
    if norm == 'gn':
    ...
    # return Multi_ResNet(BasicBlock, [2,2,2,2], n_blocks, num_classes=num_classes, norm_layer=MyGroupNorm)
